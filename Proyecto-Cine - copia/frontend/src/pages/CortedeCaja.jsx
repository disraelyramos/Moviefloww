...
export default function CortedeCaja() {
  ...
  const handleExportPDF = async () => {
    ...
    const resolvedDesde = isPersonalizado
      ? desde
      : (rangosFechas?.[rango]?.desde || desde || "");
    const resolvedHasta = isPersonalizado
      ? hasta
      : (rangosFechas?.[rango]?.hasta || hasta || "");
